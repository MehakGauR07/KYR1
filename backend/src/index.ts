...
import { case2Model } from '../models/case2';
...
app.use(cors({
  origin: 'https://kyr-frontend.vercel.app',  // Adjust to match your frontend origin
  methods: ['GET', 'POST', 'PUT', 'DELETE'],
  allowedHeaders: ['Content-Type', 'Authorization'],
  credentials: true  // Enable if using credentials
}));
